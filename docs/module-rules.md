...
BACK-000 solo conserva estos paquetes con `package-info.java`. La configuración de seguridad en `shared.security` deniega solicitudes sin implementar autenticación.
