...
class PortfolioController {
    ...
    @Operation(summary = "Publish a piece in the fixer's own portfolio",
            description = "The body carries a storage key only. The file is uploaded by the client "
                    + "against a signed URL, so no media content crosses this API. Requires a verified fixer.")
