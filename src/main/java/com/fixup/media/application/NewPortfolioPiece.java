...
/**
 * What the client sends to publish: a storage key, never the file itself. The key is not yet
 * issued nor verified by the backend; see {@code docs/media-storage.md}.
 */
