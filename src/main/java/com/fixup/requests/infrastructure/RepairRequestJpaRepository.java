...
interface RepairRequestJpaRepository extends JpaRepository<RepairRequestEntity, UUID> {
    ...
    // FR-UC-08: solo las solicitudes vivas. Una terminada o cancelada ya no debe nada, y una fila
    // anterior a la migración no tiene plazo (sla_deadline nulo) y queda fuera por diseño.
